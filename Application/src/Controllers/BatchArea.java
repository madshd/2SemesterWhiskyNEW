...
// HashMap<TasteProfile, Integer> blueprint) {
...
// throw new IllegalArgumentException("The total percentage of the taste
// profiles must be 100.");
// }
...
// */
// public static TasteProfile createNewTasteProfile(String profileID, String
// description,
// ArrayList<TastingNote> tags) {
// if (tags.isEmpty()) {
// throw new IllegalArgumentException("A TasteProfile must have at least one
// tag.");
// } else {
...
// // TODO: Implement checks for max num of possible bottles according to
// quantity
...
// */
// public static HashMap<TasteProfile, Integer> generateProductionVolume(int
// numBottlesToProduce, Batch batch) {
// int totalProductionVolumeML = numBottlesToProduce *
// batch.getProduct().getBottleSize() * numBottlesToProduce;
// HashMap<TasteProfile, Integer> blueprint =
// batch.getProduct().getFormula().getBlueprint();
